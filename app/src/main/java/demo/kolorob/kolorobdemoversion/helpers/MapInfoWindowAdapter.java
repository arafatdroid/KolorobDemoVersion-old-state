...
public class MapInfoWindowAdapter implements InfoWindowAdapter {
    ...
    public MapInfoWindowAdapter(final Context context,ArrayList<EducationServiceProviderItem> et,int cat_id){
        inflater = (LayoutInflater)context.
                getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        educationServiceProvider = et;//setting the education object
